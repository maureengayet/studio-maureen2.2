const PrivacyPage = () => {
	return (
		<section className="narrow max-w w-full my-40">
			...
			<p class="mt-4">
				At <strong>Studio Maureen</strong>, I respect your privacy. This page explains what data is collected when you visit my website and how it’s
				used.
			</p>

			<h2 class="text-2xl font-semibold mt-8">1. What data is collected?</h2>
			<p class="mt-2">
				When you browse this website, some basic information is collected to help me understand how people interact with the site. This includes:
			</p>
			...
			<p>
				This data is <strong>not</strong> personally identifiable and is only used to improve the site.
			</p>

			<h2 class="text-2xl font-semibold mt-8">2. Cookies</h2>
			<p class="mt-2">
				This website uses <strong>third-party cookies</strong> — small text files stored on your device — for the following purpose:
			</p>
			...
			<p>
				These cookies are only set <strong>after you accept</strong> the cookie banner.
			</p>
			...
			<p class="mt-2">I do not sell, rent, or share your personal information with third parties.</p>

			<h2 class="text-2xl font-semibold mt-8">5. Contact</h2>
			<p class="mt-2">If you have any questions about this privacy policy, feel free to reach out via the contact form or by email.</p>
		</section>
	);
};
