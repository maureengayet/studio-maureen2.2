...
const About = () => {
	return (
		<section className="About relative max-w w-full leading-snug lg:leading-snug ">
			<p className="">
				<span className="ml-20">An </span>experienced freelance web designer and developer dedicated to creating innovative digital solutions. With
				over 8 years of expertise, I specialise in crafting high-quality, user-friendly applications tailored to meet your unique needs.
			</p>
			<p>
